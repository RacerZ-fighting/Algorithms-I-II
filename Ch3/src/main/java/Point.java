 ...
 *
 * An immutable data type for points in the plane. For use on Coursera, Algorithms Part I programming assignment.
 *
 ******************************************************************************/
...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        if (this.x == that.x && this.y == that.y) {
            res = Double.NEGATIVE_INFINITY; // equal
        } else if (this.y == that.y) {
            res = +0.0;  // horizontal
        } else if (this.x == that.x) {
            res = Double.POSITIVE_INFINITY; // vertical
        } else {
